      ...
      @if (Auth::user()-> is_admin )
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="{{route('add.inven')}}"><i class="fa fa-angle-double-right"></i>Tambah Inventaris</a></li>
              <li><a href="{{route('index.inven')}}"><i class="fa fa-angle-double-right"></i>List Inventaris</a></li>
              <li><a href="{{route('reserve.inven')}}"><i class="fa fa-angle-double-right"></i>Pinjam Inventaris</a></li>
              <li><a href="{{route('list.invenadmin')}}"><i class="fa fa-angle-double-right"></i>List Peminjaman</a></li>
            </ul>
          </li>
        </ul>
      @else
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="{{route('index.invenuser')}}"><i class="fa fa-angle-double-right"></i>List Inventaris</a></li>
              <li><a href="{{route('reserve.inven')}}"><i class="fa fa-angle-double-right"></i>Pinjam Inventaris</a></li>
              <li><a href="{{route('list.invenuser')}}"><i class="fa fa-angle-double-right"></i>List Peminjaman</a></li>
            </ul>
          </li>
        </ul>      
    @endif
