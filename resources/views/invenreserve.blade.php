...
@section('content')
	<div class="col-xs-5">
		<form method="POST" action="/inventaris/reserve">
			{{ csrf_field() }}
			<div class="form-group">
				<label for="barang">Peminjaman Barang</label>
				<input type="text" class="form-control" name="barang" placeholder="Nama Barang" required>
			</div>
			<div class="form-group">
				<input type="text" class="form-control" name="jumlah" placeholder="Jumlah Dipinjam" required>
			</div>
			<div class="form-group">
